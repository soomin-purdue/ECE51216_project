...
\small
\ttfamily
python3 DPLL\_heuristic.py benchmarks/sat/example-1.cnf --heuristic baseline --propagation baseline
\end{quote}
...
\small
\ttfamily
python3 DPLL\_heuristic.py input.cnf --heuristic dlis --propagation watched --print-stats
\end{quote}
